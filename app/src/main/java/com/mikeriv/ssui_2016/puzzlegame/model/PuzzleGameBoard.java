...
public class PuzzleGameBoard {
     ...
     * The photo1's below represent the neighbors of a tile called X. 0's are not neighbors)
     * |0 | photo1 | 0
     * |photo1 | X | photo1
     * |0 | photo1 | 0
     *
    ...
    public boolean areTilesNeighbors(
        ...
        int xOffset = Math.abs(firstTileRow - secondTileRow);
        int yOffset = Math.abs(firstTileCol - secondTileCol);
        return (xOffset == 0 && yOffset == 1) || (xOffset == 1 && yOffset == 0);
